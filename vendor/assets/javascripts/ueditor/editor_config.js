...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[["bold","italic","underline","strikethrough","forecolor","backcolor","justifyleft","justifycenter","justifyright","justifyjustify","indent","removeformat","formatmatch","autotypeset","pasteplain","customstyle","insertunorderedlist","insertorderedlist","source","fullscreen","preview","help"],["insertimage","emotion","insertvideo","attachment","blockquote","spechars","link","unlink"],["inserttable","deletetable","mergedown","mergeright","splittorows","splittocols","splittocells","mergecells"],[]]
